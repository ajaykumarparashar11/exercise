...
var AppComponent = /** @class */ (function () {
    function AppComponent() {
        this.title = 'Exercise Management Tool';
    }
...
/* harmony import */ var _exercises_exercises_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./exercises/exercises.component */ "./src/app/exercises/exercises.component.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [
                ...
                _exercises_exercises_component__WEBPACK_IMPORTED_MODULE_13__["ExercisesComponent"],
...
module.exports = "<h3>Activity Feed</h3>\n<div class=\"grid grid-pad\">\n  <a *ngFor=\"let exercise of exercises\" class=\"col-1-4\" routerLink=\"/detail/{{exercise.id}}\">\n    <div class=\"module exercise\">\n      <h4>{{exercise.category}}</h4>\n    </div>\n  </a>\n    \n    <div class=\"outer\">\n        <div col-></div>\n    </div>\n</div>\n\n<!--<app-hero-search></app-hero-search>-->\n"
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _exercise_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../exercise.service */ "./src/app/exercise.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(exerciseService) {
    ...
    DashboardComponent.prototype.getExercises = function () {
        var _this = this;
        this.exerciseService.getExercises()
            .subscribe(function (exercises) { return _this.exercises = exercises; });
    };
    DashboardComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_exercise_service__WEBPACK_IMPORTED_MODULE_1__["ExerciseService"]])
    ], DashboardComponent);
...
var ExerciseService = /** @class */ (function () {
    function ExerciseService(http, messageService) {
        this.http = http;
        this.messageService = messageService;
        this.exercisesUrl = 'api/exercises'; // URL to web api
    }
    /** GET exercises from the server */
    ExerciseService.prototype.getExercises = function () {
        var _this = this;
        return this.http.get(this.exercisesUrl)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (exercises) { return _this.log("fetched exercises"); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError('getExercises', [])));
    };
    /** GET exercise by id. Return `undefined` when id not found */
    ExerciseService.prototype.getExerciseNo404 = function (id) {
        var _this = this;
        var url = this.exercisesUrl + "/?id=" + id;
        return this.http.get(url)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (exercises) { return exercises[0]; }), // returns a {0|1} element array
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (h) {
            var outcome = h ? "fetched" : "did not find";
            _this.log(outcome + " exercise id=" + id);
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError("getExercise id=" + id)));
    };
    /** GET exercise by id. Will 404 if id not found */
    ExerciseService.prototype.getExercise = function (id) {
        var _this = this;
        var url = this.exercisesUrl + "/" + id;
        return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (_) { return _this.log("fetched exercise id=" + id); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError("getExercise id=" + id)));
    };
    /* GET exercises whose name contains search term */
    ExerciseService.prototype.searchExercises = function (term) {
        var _this = this;
        if (!term.trim()) {
            // if not search term, return empty exercise array.
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])([]);
        }
        return this.http.get("api/exercises/?name=" + term).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (_) { return _this.log("found exercises matching \"" + term + "\""); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError('searchExercises', [])));
    };
    //////// Save methods //////////
    /** POST: add a new exercise to the server */
    ExerciseService.prototype.addExercise = function (exercise) {
        var _this = this;
        return this.http.post(this.exercisesUrl, exercise, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (exercise) { return _this.log("added exercise w/ id=" + exercise.id); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError('addExercise')));
    };
    /** DELETE: delete the exercise from the server */
    ExerciseService.prototype.deleteExercise = function (exercise) {
        var _this = this;
        var id = typeof exercise === 'number' ? exercise : exercise.id;
        var url = this.exercisesUrl + "/" + id;
        return this.http.delete(url, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (_) { return _this.log("deleted exercise id=" + id); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError('deleteExercise')));
    };
    /** PUT: update the exercise on the server */
    ExerciseService.prototype.updateExercise = function (exercise) {
        var _this = this;
        return this.http.put(this.exercisesUrl, exercise, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(function (_) { return _this.log("updated exercise id=" + exercise.id); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError('updateExercise')));
    };
    /**
     ...
     */
    ExerciseService.prototype.handleError = function (operation, result) {
        var _this = this;
    ...
    ExerciseService.prototype.log = function (message) {
...
var ExercisesComponent = /** @class */ (function () {
    function ExercisesComponent(exerciseService) {
        this.exerciseService = exerciseService;
    }
    ...
    ExercisesComponent.prototype.add = function (category, distance, time) {
        var _this = this;
        category = category.trim();
        if (!category && !distance && !time) {
            return;
        }
        this.exerciseService.addExercise({ category: category })
    ...
    ExercisesComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            styles: [__webpack_require__(/*! ./exercises.component.css */ "./src/app/exercises/exercises.component.css")]
        }),
        __metadata("design:paramtypes", [_exercise_service__WEBPACK_IMPORTED_MODULE_1__["ExerciseService"]])
    ], ExercisesComponent);
...
var InMemoryDataService = /** @class */ (function () {
    ...
    InMemoryDataService.prototype.createDb = function () {
        ...
        var users = [];
        var exercises = [
            { id: 1, category: 'Running', distance: '5', time: '25' }
        ];
        return { heroes: heroes, users: users, exercises: exercises };
    };
...
module.exports = __webpack_require__(/*! F:\wamp64\www\exercise\src\main.ts */"./src/main.ts");
